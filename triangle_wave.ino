...
int screw_steps = 0;
boolean screw_direction = true;
int total_steps = 0;  // for printing purposes
...
void loop() {
  for(int i=0; i<20000; i++){
    ...
    if (should_print == 100) {
      ...
      Serial.print(total_steps*0.01953125);
      Serial.print(",");
  ...
  // it's a triangle wave that reverses direction every 
  // 20000 cycles/steps!
